...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
          ...
          'category' => 'required|string',
           ...
           'blog_image' => 'nullable|file|mimes:jpeg,png,jpg,gif,svg|max:2048', // Allow larger images, with a size limit
  ...
  // Save the blog to the database
    ...
    public function postsList()
    {
        ...
        // Pass the blogs to the view
        return view('posts_list', compact('blogs'));
    }
  ...
  public function postPage(int $blogId, string $post_title)
{
