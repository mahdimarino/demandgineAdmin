...
<head>
    ...
    <meta charset="utf-8">
    <title>DemandGine</title>
    <link rel="icon" href="{{ asset('favicon.png') }}" type="image/gif" sizes="24x24">
                        ...
                        <div class="header-row">
                            ...
                            <div class="header-col mid">
                                ...
                                <ul id="mainmenu">
                                    ...
                                    <li><a style="color:black" href="{{ route('home') }}#ourapproach">Our Approach</a></li>
                                    <li><a style="color:black" href="{{ route('home') }}#oursolutions">Our Solutions</a></li>
                                    
                                    <li class="onlypc"><a style="color:black" href="{{ route('home') }}#ourdata">Our Data</a></li>
                                    <li class="onlymobile"><a style="color:black" href="{{ route('home') }}#ourdata2">Our Data</a></li>
                                    <li class="onlypc"><a style="color:black" href="{{ route('home') }}#whydemandgine">Why DemandGine</a></li>
                                    <li class="onlymobile"><a style="color:black" href="{{ route('home') }}#whydemandgine2">Why DemandGine</a></li>
                                    <li><a style="color:black" href="{{ route('posts_list') }}">Blog</a></li>
                                    <li class="onlymobile"><a style="color:black" href="{{ route('contact') }}">Contact</a></li>
                                    </ul>
                                    <div class="col-right onlypc">
                                        <a class="btn-custom" href="{{ route('contact') }}">Contact Us</a>
                                    </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xs-4">
                                <div class="widget">
                                    ...
                                    <ul>
                                        ...
                                        <li class="onlymobile"><a href="index.php#whydemandgine2">Blog</a>
                                        </li>
