        ...
        <tbody>
            ...
            <tr>
                <td scope="row"><a target="_blank"
                        href="{{ route('post_page', ['blogId' => $blog->id, 'post_title' => Str::slug($blog->title)]) }}">{{
                        $blog->id }}</a></td>
                <td>{{ $blog->title}}</td>
                <td>{{ $blog->post_date }}</td>
                <td>
                    <a target="_blank" href="{{ route('post_page', ['blogId' => $blog->id, 'post_title' => Str::slug($blog->title)]) }}" class="btn btn-sm btn-primary">
